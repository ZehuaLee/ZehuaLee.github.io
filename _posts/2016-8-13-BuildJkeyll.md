...
* 从这个[网站](http://jekyllcn.com/获取安装)，安装步骤仅仅三步。
...
git init
```
* 寻找合适的blog主题，直接百度搜索  _Jekyll Theme_ [传送门](http://jekyllthemes.org/)
...
* 在 ___ _posts ___ 中记录博文的markdown格式的博客。命名方法遵守YY－MM－DD－XXXX的格式。

* 通过git同步到github远程库，https://github.com/username/username.github.io 。

等几分钟，github会自动渲染，几分钟后直接访问 https://username.github.io 即可。
